class RecipeManager:
    ...
    def add_recipe_from_input(self):
        ...
        new_recipe.set_no_servings(no_servings)
        new_recipe.set_calories_per_portion(calories_per_portion)
        for ingredient in ingredients:
            new_recipe.set_ingredients(ingredient.strip())
        for instruction in instructions:
            new_recipe.set_instructions(instruction.strip())
