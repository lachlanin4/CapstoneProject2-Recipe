...
print(f"Number of recipes in list now {len(testrecipemanager.recipes)} and its {testrecipemanager.recipes[0].title}")
...
print(f"Number of recipes in list now {len(testrecipemanager.recipes)} and its {testrecipemanager.recipes[0].title} and {testrecipemanager.recipes[1].title}")
